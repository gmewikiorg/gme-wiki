...
export class EarningsTableComponent {
  ...
  public backgroundColor(
    ...
    if (column === 'REVENUE') {
      ...
      return this._getNonRedColor(0, minMax.max, propertyValue);
      ...
      return this._getNonRedColor(minMax.min, minMax.max, propertyValue);
      ...
      return this._getNonRedColor(minMax.min, minMax.max, propertyValue, true);
