...
import { TimelineEventURL, TimelineEventUrlSrc } from '../timeline-items/timeline-item/timeline-event-url.interface';
...
export class TimelineAnnotationBoxComponent implements OnInit {
  ...
  private _timelineEvent: TimelineEventOLD | null | undefined= null;
  ...
  public get event(): TimelineEventOLD | null | undefined { return this._timelineEvent; }
  ...
  ngOnInit() {
    ...
    this._controlsService.timelineItemAnnotation$.subscribe((timelineEvent: TimelineEventOLD | null | undefined) => {
      ...
      const lightColor = TimelineEventOLD.getTypeColor(this._timelineEvent?.mainType, 0.1);
      const darkColor = TimelineEventOLD.getTypeColor(this._timelineEvent?.mainType, 0.2);
      ...
      this._eventNgStyle = {
        border: '2px solid ' + TimelineEventOLD.getTypeColor(this._timelineEvent?.mainType, 1),
        background: gradient,
      }
