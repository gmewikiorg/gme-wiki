...
import { EarningsChartOption } from '../../main-pages/financials/choose-earnings-chart/earnings-chart-option.enum';
...
export class Fy24EarningsComponent {
  ...
  constructor(private _screenService: ScreenService, private titleService: Title, private meta: Meta) {
    ...
    this.meta.addTags([
      { name: 'description', content: 'GameStop’s FY24: Increasing Profitability and Value' },
  ...
  public get equityChartConfig(): { article: 'FY24', chart: EarningsChartOption, } { return { article: 'FY24', chart: EarningsChartOption.STOCKHOLDERS_EQUITY } }
  public get storesChartConfig(): { article: 'FY24', chart: EarningsChartOption, } { return { article: 'FY24', chart: EarningsChartOption.REVENUE_VS_STORES } }
  public get interestIncomeChartConfig(): { article: 'FY24', chart: EarningsChartOption, } { return { article: 'FY24', chart: EarningsChartOption.INTEREST_INCOME } }
  public get operatingIncomeConfig(): { article: 'FY24', chart: EarningsChartOption, } { return { article: 'FY24', chart: EarningsChartOption.OPERATING_INCOME } }
  public get netIncomeChartConfig(): { article: 'FY24', chart: EarningsChartOption, } { return { article: 'FY24', chart: EarningsChartOption.NET_INCOME } }
