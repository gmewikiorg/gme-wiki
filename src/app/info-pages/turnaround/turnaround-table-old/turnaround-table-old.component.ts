...
@Component({
  selector: 'app-turnaround-table-old',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './turnaround-table-old.component.html',
  styleUrl: './turnaround-table-old.component.scss'
})
export class TurnaroundTableOldComponent implements OnInit{
