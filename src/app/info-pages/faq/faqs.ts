...
export const faqs: FAQ[] = [
    ...
    { question: 'How can I invest in GME stock?', answerText: ['You can invest in GME stock by opening a brokerage account, depositing funds, and purchasing shares of GME on the stock exchange where it is listed.'], answerUrls: [], id: 16, section: 'STOCK' },
    { question: 'What is the current price of GME stock?', answerText: ['The current price of GME stock can be found on financial platforms, stock exchange websites, or through your brokerage account.'], answerUrls: [], id: 17, section: 'STOCK' },
    { question: 'Which stock exchange is GME listed on?', answerText: ['GME is listed on the New York Stock Exchange (NYSE).'], answerUrls: [], id: 18, section: 'STOCK' },
    { question: 'Where can I find GME’s historical stock performance?', answerText: ['You can find GME’s historical stock performance on financial news websites, your brokerage account, or platforms like Yahoo Finance or Google Finance.'], answerUrls: [], id: 19, section: 'STOCK' },
    { question: 'Is GME a good stock to invest in?', answerText: ['The suitability of GME as an investment depends on individual financial goals and risk tolerance. Consider consulting a financial advisor before making investment decisions.'], answerUrls: [], id: 20, section: 'STOCK' },
    { question: 'What are the risks of investing in GME?', answerText: ['Investing in GME carries risks such as market volatility, competition, and the company’s ability to adapt to digital trends. Always diversify your portfolio to mitigate risk.'], answerUrls: [], id: 21, section: 'STOCK' },
